...
@Slf4j @Service  @AllArgsConstructor
    public class CustomUserDetailsService implements UserDetailsService {
        ...
        private final com.example.twoway_movie.Repository.MemberRepository memberRepository;
        @Override
        ...
        public UserDetails loadUserByUsername(String id) {//회원정보를 담는
            ...
            com.example.twoway_movie.Entity.MemberEntity memberEntity = memberRepository.findOneById(id);
